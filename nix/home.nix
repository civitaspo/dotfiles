...
# Agent skill trees are directory symlinks from private so Cursor, Codex, and
# Cursor Cloud Agent skill sync share the same managed configuration.
{ lib, inputs, ... }:
  ...
  home = {
    ...
    file =
      ...
      // {
        ...
        # Cursor Cloud Agents only copy ~/.cursor/skills/, not ~/.agents/skills/.
